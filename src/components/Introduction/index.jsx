...
const Introduction = () => {
    return (
        <section className='mt-5 px-10 relative lg:flex lg:justify-between lg:mt-16'>
            <div className='text-center max-w-550 mx-auto z-10 lg:text-left lg:w-485 lg:mx-0'>
