...
const CroissantsSection = () => {
    return (
        <section className='mt-28 lg:flex lg:justify-between lg:items-center lg:mt-32'>
            <div className='px-8 text-center text-brown-primary max-w-525 mx-auto lg:text-left lg:max-w-full lg:mx-0 lg:flex-1'>
