...
const DeliverySection = () => {
    return (
        <section className='mt-20 mx-8 px-11 py-10 bg-gradient-pink-delivery rounded-3xl lg:flex lg:flex-row-reverse lg:items-center lg:justify-between lg:py-0 lg:mt-40'>
            <div className='text-center lg:text-right'>
                ...
                <div className='max-w-485 mx-auto lg:max-w-80 lg:ml-44 lg:text-right'><Button sizeText='text-xl' bgColor='bg-white' textColor='text-brown-primary' /></div>
            </div>
