...
const DeliverySection = () => {
    return (
        <section className='mt-20 mb-96 mx-8 px-11 py-10 bg-gradient-pink-delivery rounded-3xl lg:flex lg:flex-row-reverse lg:items-center lg:justify-between lg:py-0'>
